...
<script>
	...
	function btnNullExcption(){
		...
		field = document.createElement("input");
		field.setAttribute("type","hidden");
		field.setAttribute("name","age");
		field.setAttribute("value",age[0].value);
		form.appendChild(field);
		
		field = document.createElement("input");
		field.setAttribute("type","hidden");
		field.setAttribute("name","gender");
		field.setAttribute("value",gender[0].value);
		form.appendChild(field);
...
<body>
	...
	<hr>
		...
		<label>나이 &nbsp;&nbsp;<input type="text" size="1" name="age"></label><br><br>
		<label>성별 &nbsp;&nbsp;
		<select name="gender">
